const global = {
  ...
  api: {
    api_key: "00437415d9281b690dfc403b6f4344d0",
...
function displayBackgroundImage(type, backdrop_path) {
  ...
  overlayDiv.style.backdroundRepeat = "no-repeat";
...
async function fetchAPIData(endpoint) {
  ...
  // store you keys and make request from a server
